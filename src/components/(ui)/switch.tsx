...
export function Switch({ children, ...props }: Props) {
  return (
    ...
    >
      <span className="bg-subtle group-data-selected:bg-btn group-data-focus-visible:ring-focus inline-flex h-6 w-10 shrink-0 rounded-full p-[3px] shadow-[inset_0_0_0_1px_var(--border-color-input)] transition duration-200 ease-out group-data-focus-visible:ring-2 group-data-focus-visible:ring-offset-2 group-data-hovered:shadow-[inset_0_0_0_1px_var(--border-color-input-hovered)] group-data-pressing:scale-[0.97] group-data-selected:shadow-none sm:h-5 sm:w-8">
