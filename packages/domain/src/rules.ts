...
export const JOKER_RULES = [
  ...
  {
    value: "zwei-joker-vorrunde-dann-einmal-pro-runde" as const,
    label: "Zwei Joker in der Vorrunde, danach einmal pro Runde",
    description:
      "Auf einen Tipp kann ein Joker gesetzt werden. Die Punkte dieses Tipps werden verdoppelt. In der ersten Runde stehen insgesamt maximal zwei Joker zur Verfügung. Ab der zweiten Runde kann pro Runde maximal ein Joker gesetzt werden.",
  },
];
