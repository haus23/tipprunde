...
const inputStyles =
  "border-subtle bg-surface text-app rounded-sm border px-2.5 py-1.5 text-sm placeholder:text-placeholder outline-none transition ease-out data-focused:ring-2 data-focused:ring-accent/60";
