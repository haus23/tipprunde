...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `keine-besonderheiten`      | No modification                                                                                                                          |
| `torabweichung-bonus-malus` | After round completion: player with lowest accumulated goal deviation gets +1 point; highest gets −1 point. A missing tip counts as 0:0. |
